...
SECRET_KEY = 'django-insecure-q&ie=6*^b)-gcbpmltnk64sz@_e(6vmuf3m2yf=n@f&_h=hnkx'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'order_management/web/templates')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
